...
const Commercial: NextPage = () => {
    return (
        ...
        <meta name="description" content="Looking for commercial carpet cleaning? Mike does it best! Our industry standard processes and high quality gear are sure to give you the best carpet cleaning."/>
