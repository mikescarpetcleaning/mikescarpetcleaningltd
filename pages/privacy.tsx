...
const Privacy: NextPage = () => {
    return (
        <aside className="pp">
            ...
            <li>
            <p><strong>Website</strong> refers to Excel Carpet Cleaning, accessible from <a href="www.excelcarpetcleaning.com" rel="external nofollow noopener" target="_blank">www.excelcarpetcleaning.com</a></p>
            </li>
            <li>
